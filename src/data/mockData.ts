...
export const USERS: User[] = [
  { id: 1, nama: "Admin IT SMPN 4", email: "admin@sakura.sch.id", role: "Administrator IT", avatar: avatarAdmin, departemen: "IT" },
  ...
  { id: 4, nama: "Budi Santoso", email: "teacher@sakura.sch.id", role: "Guru", avatar: avatarTeacher, departemen: "Guru" },
];
...
export const DOCUMENTS: Document[] = [
  ...
  {
    id: 2, nomorDokumen: "NLI-2024-015", judul: "Laporan Nilai Semester Ganjil 2024-2025 Kelas 7A", kategori: "Nilai", kelas: "Kelas 7A",
    pengunggah: { id: 4, nama: "Budi Santoso", role: "Guru", avatar: avatarTeacher },
    tanggalUpload: "2025-09-01T08:24:00Z", tanggalEdit: "2025-09-01T09:54:00Z", status: "Menunggu", versi: 1,
    fileUrl: "/mock/sample.pdf", catatan: "Sensitive Document",
    auditTrail: [
      { time: "2025-09-01T08:24:00Z", user: { nama: "Budi Santoso", avatar: avatarTeacher, role: "Guru" }, action: "Mengunggah dokumen" },
      { time: "2025-09-01T09:24:00Z", user: { nama: "Dr. Siti Rahayu", avatar: avatarPrincipal, role: "Kepala Sekolah" }, action: "Melihat dokumen" },
      { time: "2025-09-01T09:54:00Z", user: { nama: "Dr. Siti Rahayu", avatar: avatarPrincipal, role: "Kepala Sekolah" }, action: "Menyetujui dokumen" },
    ],
  },
  {
  ...
  },
  {
    ...
    pengunggah: { id: 3, nama: "Dewi Kartika", role: "Staff Administrasi", avatar: avatarStaff },
    tanggalUpload: "2025-09-10T11:00:00Z", tanggalEdit: "2025-09-10T11:00:00Z", status: "Ditolak", versi: 1,
    fileUrl: "/mock/sample.pdf",
    auditTrail: [
      { time: "2025-09-10T11:00:00Z", user: { nama: "Dewi Kartika", avatar: avatarStaff, role: "Staff Administrasi" }, action: "Mengunggah dokumen" },
      { time: "2025-09-10T15:00:00Z", user: { nama: "Dr. Siti Rahayu", avatar: avatarPrincipal, role: "Kepala Sekolah" }, action: "Menolak dokumen" },
    ],
  },
  {
    id: 5, nomorDokumen: "ARS-2024-001", judul: "Arsip Data Siswa Kelas 8B 2023", kategori: "Data Siswa", kelas: "Kelas 8B",
    pengunggah: { id: 3, nama: "Dewi Kartika", role: "Staff Administrasi", avatar: avatarStaff },
    ...
    auditTrail: [
      ...
      { time: "2025-08-01T10:00:00Z", user: { nama: "Admin IT SMPN 4", avatar: avatarAdmin, role: "Administrator IT" }, action: "Mengarsipkan dokumen" },
    ],
  },
  {
    ...
    fileUrl: "/mock/sample.pdf",
    auditTrail: [
      { time: "2025-09-12T07:30:00Z", user: { nama: "Budi Santoso", avatar: avatarTeacher, role: "Guru" }, action: "Mengunggah dokumen" },
    ],
  },
  {
...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  "Administrator IT": ["dashboard.view", "documents.upload", "documents.archive", "documents.edit", "users.manage", "roles.manage", "audit.view", "profile.edit"],
  "Kepala Sekolah": ["dashboard.view", "documents.approve", "documents.reject", "documents.archive", "audit.view", "profile.edit"],
  "Staff Administrasi": ["dashboard.view", "documents.upload", "documents.archive", "documents.edit", "profile.edit"],
