      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 bg-background">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-2.5 rounded-lg border border-input bg-background text-sm font-medium hover:bg-muted transition-colors"
          >
